...
console.log('🔧 Clean JSX Fixer...\n');

// Create backup
const backupPath = './src/app/project-manager/page.tsx.backup19';
fs.writeFileSync(backupPath, content);
console.log('📄 Created backup at:', backupPath);

// Fix the JSX structure by removing the problematic section and rebuilding it
...
// Apply the fix
console.log('🔧 Applying clean JSX fix...');
let fixedContent = fixJSXStructure(content);

// Write the fixed content
fs.writeFileSync(filePath, fixedContent);

console.log('✅ Applied clean JSX fix');
